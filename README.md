...
✅ Natural Language Understanding Interprets user queries through NLP (Natural Language Processing).

Understands various ways users may phrase their request (e.g., “Suggest a romantic novel” or “I feel low, what should I read?”).

✅ User-Centric Design Friendly and conversational tone.
...
✅ Wide Book Coverage Covers a broad range of genres including but not limited to:
...
✅ Trending & Top Picks Suggests trending books and current bestsellers.

Lists top books per genre or per author.

# 🛠️Tech Stack 🛠️
💠Frontend: HTML5, CSS3 Chatbot 

💠Integration: IBM Watson Assistant (Web Chat SDK) 
